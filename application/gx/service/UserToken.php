...
namespace app\gx\service;
use app\gx\exception\TokenException;
use app\gx\exception\WeChatException;
use app\gx\lib\enum\ScopeEnum;
use think\Exception;
use app\gx\model\User as UserModel;
