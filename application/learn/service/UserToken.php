...
namespace app\learn\service;
use app\learn\exception\TokenException;
use app\learn\exception\WeChatException;
use app\learn\lib\enum\ScopeEnum;
use think\Exception;
use app\learn\model\User as UserModel;
